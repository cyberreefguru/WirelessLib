...
void loop() {
	...
	//
	//	printf("Sending Command 100: %d\n\r", cmdRunway->command);
	//
	//	sendCommand();
	//	delay(6000);
	//
	//	cmdRunway->onTime = 50;
	//	printf("Sending Command 50: %d\n\r", cmdRunway->command);
	//
	//	sendCommand();
	//	delay(4000);
	//
	//	cmdRunway->onTime = 25;
	//	printf("Sending Command 25: %d\n\r", cmdRunway->command);
	//
	//	sendCommand();
	//	delay(4000);
...
//	 {
//		 cmdSetAll->onColor = WHITE;
//		 sendCommand();
//		 delay(250);
//		 cmdSetAll->onColor = BLACK;
//		 sendCommand();
//		 delay(250);
//	 }
